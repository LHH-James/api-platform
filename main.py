...
class wish_execute_others(tornado.web.RequestHandler):
    executor = ThreadPoolExecutor(40)
    @run_on_executor
    #@tornado.web.asynchronous
    #@gen.coroutine
    def post(self):
        result = http_method.wish_execute_others(self)
        self.write(result)
        self.finish()
        print('finish')

class wish_execute_product_boost(tornado.web.RequestHandler):
    executor = ThreadPoolExecutor(40)
    @run_on_executor
    # @tornado.web.asynchronous
    # @gen.coroutine
    def post(self):
        result = http_method.wish_execute_product_boost(self)
        self.write(result)
        self.finish()
        print('finish')
...
# WISH
            ...
            ('/wish/others', wish_execute_others),
            ('/wish/product_boost', wish_execute_product_boost),
